...
## 10. Plattform-Verifikation auf macOS-Dev
...
# 3. Bestehender Stiftungs-Manager — nur Hostname/Port + Certs setzen
PROBE_TEST_BROKER=mqtt.intern PROBE_TEST_PORT=8883 pytest -m integration
```
